    ...
    <div class="md:w-1/2 p-10 bg-white  rounded-lg shadow-xl ">
        <form action="{{ route('user.update', $user->id) }}" method="POST" novalidate>
            ...
            <div class="mb-3">
                ...
                <input id="name" name="name" type="text" placeholder="Tu Nombre" value="{{ $user->name }}" class="border p-2 w-full rounded-lg @error('name') border-red-500 @enderror">
            ...
            <div class="mb-3">
                ...
                <input id="username" name="username" type="text" placeholder="Tu Nombre de Usuario" value="{{ $user->username }}" class="border p-2 w-full rounded-lg @error('username') border-red-500 @enderror">
            ...
            <div class="mb-3">
                ...
                <input id="email" name="email" type="email" placeholder="Tu email de registro" value="{{ $user->email }}" class="border p-2 w-full rounded-lg @error('email') border-red-500 @enderror">
            ...
            <div class="mb-3">
                ...
                <input id="direccion" name="direccion" type="text" placeholder="Donde vives?" value="{{ $user->direccion }}" class="border p-2 w-full rounded-lg @error('email') border-red-500 @enderror">
            ...
            <div class="mb-3">
                ...
                <input id="telefono" name="telefono" type="phone" placeholder="Tu telefono personal" value="{{ $user->telefono }}" class="border p-2 w-full rounded-lg @error('email') border-red-500 @enderror">
